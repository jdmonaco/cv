...
{ 
Expertise in neural networks, state-of-the-art statistical methods, high-performance computing, data analysis, and modeling techniques. Extensive study of hippocampal function and spatial memory, which are high-dimensional neurobiological systems with uncertainties across many scales. Dr. Monaco is highly familiar with stochastic processes, continuous and discrete modeling methods, and data-driven modeling of complex biological systems. Dr. Monaco applies software engineering best practices to bolster his foundation and research pursuits in theoretical cognitive neuroscience. 
}
...
\item
  ...
  \begin{itemize}
    \item Developed novel statistical methods for quantitative analysis of simultaneous behavioral and electrophysiological recordings in rats to develop insights into circuit-specific dynamics of spatial code formation across different spatial environments; and
    \item Developed improved models of temporal coding in neural networks that provide stable integration of idiothetic cues such as self-motion velocity signals to support mammalian navigation.    
  \end{itemize}

\item
  \begin{tabular*}{6.3in}{l@{\extracolsep{\fill}}r}
      \textbf{Graduate Research Assistant} & 2003--9 \\
      Center for Theoretical Neuroscience, Columbia University, New York, NY (2005--9)\\
      Volen Center for Complex Systems, Brandeis University, Waltham, MA  (2003--5)\\
      % Advisor: L.~F. Abbott, Ph.D.\\
      % Collaborators: Isabel Muzzio, Ph.D., Eric R. Kandel, Ph.D. (2006--8) \\
  \end{tabular*}

  \begin{itemize}
    \item Created and explored a novel theoretical model of entorhinal grid cells and hippocampal place cells that made key predictions about functional network structure of spatial representations that were later verified by experimental studies in other labs that contributed to the 2014 Nobel Prize in Physiology (for E. Moser and M.-B. Moser);
    ...
    \item Added functionality to a C/C++ codebase for data acquisition and analysis to allow flexible cross-platform access to neurophysiological datasets.
  \end{itemize}

\item
  \begin{tabular*}{6.3in}{l@{\extracolsep{\fill}}r}
      \textbf{Research Assistant} & 2000--3\\
  ...
  \begin{itemize}
    ...
    \item Employed CA3 model to research a variety of context-dependent sequence learning paradigms: cued completion, sequence disambiguation, goal finding, and T-maze decision making.
  \end{itemize}
...
\item
  ...
  \begin{itemize}
    ...
    \item Utilized beowulf cluster to perform molecular dynamics simulations of various hyperthermophilic proteins to discern temperature-dependent structural differences from their mesothermic counterparts ('98).
    \end{itemize}
\end{itemize}
...
{\large \textbf{Post-Publication Reviews}}
\begin{itemize}
...
\begin{description}
    \item[\quad Platforms] OS X, GNU/Linux
    \item[\quad Languages] Python, C/C++, Matlab/Octave, Java, Scala, \LaTeX, etc.
\end{description}
