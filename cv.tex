...
\begin{description}
  \item \joehl{Monaco JD}, \ldots, Hwang GM. (\emph{In preparation}).
  \itemtitle{How AI can learn from complex brain dynamics}. \emph{Nature Machine
      Intelligence}. {\bfseries Perspective article invited by the editors based on
