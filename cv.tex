...
\begin{tabular}{@{\hspace{0.2in}}l>{\raggedright\arraybackslash}p{.82\textwidth}}
  2019--2020 \hspace{0.1in} & Sreelakshmi Rajendrakumar, graduate student in
  JHU/Biomedical Engineering (BME); I mentored Sreelakshmi in neuroscience,
  hippocampal physiology, and single-unit data analysis.\\
  \tabularnewline
