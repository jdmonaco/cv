...
\begin{description}
\item \textbf{Posters}
\item[\quad] \textbf{Monaco JD}, Blair HT, and Zhang K. (\emph{upcoming}). Spatial rate/phase correlations in theta cells can stabilize randomly drifting path integrators. COSYNE 2015. Salt Lake City, UT. March~2015.
