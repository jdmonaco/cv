...
% Choose font package
\setmainfont[Mapping=tex-text,Ligatures=TeX]{Helvetica Neue} 

% Formatting macros
\newcommand{\heading}[1]{
  \bigskip{\large\color{hopkinsblue}\bfseries #1}
}
\newcommand{\subheading}[1]{
  \medskip\hspace{0.05in}{\color{hopkinsblue}\bfseries #1}\\[0.1in]
}
...
\newcommand{\researchnote}[1]{
  \begin{description}
    \item[] {\hspace{0.19in}\color{darkgray}\it #1}
  \end{description}
}
\newcommand{\researchactivity}[4]{
  \begin{minipage}[t]{\textwidth}
    \begin{tabular}{@{\hspace{0.1in}}l>{\raggedright\arraybackslash}p{.8\textwidth}}
      \makebox[1.2in][l]{#1} & \textbf{#2:}
      ``\unpubtitle{#3}.'' 
    \end{tabular}
  \researchnote{\hspace{0.04in} #4}
  \end{minipage}
  \medbreak
}
\newcommand{\lefttabline}[3]{\hspace{0.1in}\makebox[#1][l]{#2} #3\\}
...
\begin{description}
  ...
  \unpubtitle{Cognitive swarming in complex environments with attractor dynamics
    and oscillatory computing}. \emph{Biological Cybernetics}. \ul{Under Review}.
...
\begin{description}
  ...
  \item Schultz K, Agarwala S, Zhang K, and \joehl{Monaco J}. (August 15, 2019).
  ...
  \item Zhang K, \joehl{Monaco JD}, Hwang GM, Schultz KM, Kobilarov M, Foster
    DJ, Jacobs J, and Laurent Itti. (June 29, 2018). \unpubtitle{An Integrative
...
\heading{Media Releases and Interviews}
...
\heading{Websites and Social Media}
...
of spatial memory}.” Website. \aurl{http://jdmonaco.com/}}
  ...
  \item \href{https://github.com/jdmonaco}
    {\itemtitle{GitHub Repositories}. Website. \aurl{https://github.com/jdmonaco}}
  \item \href{https://twitter.com/j_d_monaco}
    {\itemtitle{Twitter Feed}. Social Media. \aurl{https://twitter.com/j\_d\_monaco}}
\end{description}

\heading{Media and Community Coverage of My Work}

\subheading{News \& Views and Post-Publication Reviews}
...
\subheading{Current External Support}
...
\begin{itemize}
  \item \href{https://www.nsf.gov/awardsearch/showAward?AWD_ID=1835279&HistoricalAwards=false}
    ...
    \begin{itemize}
      \item NSF\slash NCS FOUNDATIONS (BRAIN Initiative) Award No.~1835279
      \item \textbf{Lead PI:} Kechen Zhang
      \item \textbf{Co-PIs, JHU/APL}: Grace Hwang, Robert W. Chalmers, Kevin
        Schultz, and M. Dwight Carr
      \item \textbf{Research Associate (Co-PI Pending): \joehl{Joseph D. Monaco}}
      \itemnote{I co-developed this project and co-wrote the proposal with
          a JHU/APL colleague (see \ul{Research Program Building} below). As a
          Research Associate faculty at JHU as of FY20, my project role is currently
        being changed to co-PI.}
    \end{itemize}
  ...
  \item \href{https://projectreporter.nih.gov/project_info_description.cfm?aid=9652210&icde=42555668&ddparam=&ddvalue=&ddsub=&cr=2&csb=default&cs=ASC&pball=}
    ...
    \begin{itemize}
      \item NIH/NINDS R03 Award No.~NS109923
      ...
      \itemnote{I conceived this project, generated preliminary data, and wrote
          the proposal (see \ul{Research Program Building} below). As a Postdoctoral
        Fellow, JHU policy precluded a PI role.}
    \end{itemize}
\end{itemize}

\subheading{Previous Internal Support}
...
\begin{itemize}
  \item \href{http://scienceoflearning.jhu.edu/research/learning-to-explore-paths-through-space/}
    ...
    \begin{itemize}
      \item JHU/Science of Learning Institute (SLI) Award
      \item \textbf{PI:} Kechen Zhang
      \item \textbf{Co-PI:} David J.~Foster (now at UC Berkeley)
      \item \textbf{Research Associate:} \joehl{Joseph D.~Monaco}
      \itemnote{I conceived this project, initiated the collaboration between
          the Zhang and Foster labs, and wrote the proposal (see \ul{Research
          Program Building} below). As a Postdoctoral Fellow, JHU policy precluded a
        PI role.}
    \end{itemize}
\end{itemize}

\heading{Educational Activity}

\subheading{Classroom Instruction}
...
\subheading{Workshops/Seminars -- Regional}
...
\subheading{Workshops/Seminars -- National}
...
\pagebreak
\subheading{Workshops/Seminars -- International}
...
\subheading{Educational Program Building}

\begin{tabular}{@{\hspace{0.2in}}l>{\raggedright\arraybackslash}p{.82\textwidth}}
  2018--present \hspace{0.1in} & The NSF project (see \ul{Current External
  Support} above) was successfully funded with a substantial STEM component
  for high-school students involving the development of both a 12-week course
  and an intense 2-day seminar called ``Swarming Powered by Neuroscience.''
  I am working with our STEM education collaborators at JHU/APL to develop
  computational resources required for the curricula. Additionally, I have begun
  mentoring a high-school student intern, Marc Burlina, at JHU/APL so that he
  can help develop simulation components for this educational program.
\end{tabular}
...
\subheading{Research Program Building/Leadership (\emph{\ul{Chronological Order}})}

\researchactivity
{Mar. 2016--2018}
{Grant Proposal (JHU/SLI)}
{Learning to explore paths through space}
{This internal JHU award resulted from a collaboration with David J. Foster (now
at UC Berkeley) that I initiated to conduct modeling studies informed by his
lab’s hippocampal reactivation data. By integrating Prof.~Zhang’s mathematical
theories of spatial cognitive maps, I wrote and submitted a proposal for a
\$200K/2-year project to the JHU Science of Learning Institute. The proposal was
awarded at the \$150K level and research outcomes included (1) novel theories of
temporal synchronization coding that inspired the 2017 NSF proposal effort, and
(2) preliminary dynamical models of sharp-wave reactivation that provided the
...
{This NSF-awarded project (2018--2020) was the result of 6 months of
collaboration, brain-storming, and team-building between the Zhang lab at
JHU/SoM and a group of JHU/APL engineers, mathematicians, and scientists.
...
neuroscience. The project has so far produced two posters, a conference talk
\& proceedings publication, and a preprint \& research article submission.
Continued progress will support development of a substantial STEM educational
program based on our neuroscientific and artificial systems results.}
...
Berkeley) on the basis of the internal SLI award (2016-2018), I wrote a small
...
was awarded (2018--2020) through the NIH/NINDS R03 mechanism and I am currently
utilizing this support to build a foundation for my planned future efforts along
this research track.}
...
{In response to ONR Special Notice N00014-18-R-SN05, I helped organize a series
of collaborative meetings to design a \$2M/4-year project between JHU/APL
and JHU/SoM. I co-authored the resulting white paper that was submitted for
consideration to ONR (see \ul{White Papers} above).}
...
that I outlined in the white paper (see \ul{White Papers} above) was not invited
for a full submission. We debriefed with the sponsor, ONR PM Marc Steinberg, who
revealed that ONR was impressed with the project but that they were seeking a
different balance of elements with respect to neuroscience and AI.}
...
analyses with JHU/APL collaborators, and wrote \& submitted the white paper (see
\ul{White Papers} above) to ONR outlining a potential \$1.05M/3-year project.
ONR declined to invite us to submit a full proposal.}
...
version of the March 2018 white paper (see \ul{White Papers} above) that was
specifically invited by ONR PM Tom McKenna.}
...
\subheading{Conference Abstracts}

\begin{description}
  \item[\quad]
    \href{https://www.fens.org/Meetings/The-Brain-Conferences/Dynamics-of-the-brain/}
    {\joehl{Monaco JD}, Hwang GM, De Guzman RM, Blair HT, and Zhang K.
      (2019). \itemtitle{Spatial rate-phase coding in lateral septal ‘phaser cells’:
        single-unit data and theta-bursting models}. \emph{FENS (Federation of
        European Neuroscience Societies) Dynamics of the brain: Temporal aspects
    of computation}. North Copenhagen, Denmark. June~2019.}
  \item[\quad]
    ...
    {\joehl{Monaco JD}, Hwang GM, Schultz K, and Zhang K. (2019).
  ...
  \item[\quad]
    ...
    {Hwang GM, Schultz K, \joehl{Monaco JD}, Chalmers RW, Lau SW, Yeh BY, and
      Zhang K. (2018). \itemtitle{Self-organized swarm control using neural
      principles of spatial phase coding}. \emph{Society for Neuroscience 2018}.
    San Diego, CA. November~2018.}
  \item[\quad]
    \href{http://www.abstractsonline.com/pp8/#!/4376/presentation/6085}
    {\joehl{Monaco J}, Blair HT, and Zhang K. (2017). \itemtitle{Decoding
        septohippocampal theta cells during exploration reveals unbiased
      environmental cues in firing phase}. \emph{Society for Neuroscience 2017}.
    Washington, D.C. November~2017.}
  \item[\quad]
    \href{http://jdmonaco.com/files/monaco-paper-cosyne15.pdf}
    {\joehl{Monaco JD}, Blair HT, and Zhang K. (2015). \itemtitle{Spatial
        rate/phase correlations in theta cells can stabilize randomly drifting path
    integrators}. \emph{COSYNE 2015}. Salt Lake City, UT. March~2015.}
  \item[\quad]
  ...
  \item[\quad]
    ...
    {Rao G, \joehl{Monaco J}, and Knierim JJ. (2011). \itemtitle{Environmental
      ...
      activity}. \emph{Society for Neuroscience 2011}, 97.12/WW27. Washington,
    D.C. November~2011.}
  \item[\quad]
    \href{http://www.frontiersin.org/10.3389/conf.fnins.2010.03.00192/event_abstract}
    {\joehl{Monaco JD}, Zhang K, Blair HT and Knierim JJ. (2010).
    ...
    February~2010.}
  \item[\quad] \joehl{Monaco JD} and Abbott LF. (2009). \unpubtitle{Dynamic
  ...
  \item[\quad] \joehl{Monaco JD}, Muzzio IA, Levita L and Abbott LF. (2006).
    \unpubtitle{Entorhinal input and global remapping of hippocampal place
    fields}. \emph{CNS}. Edinburgh, UK. July~2006.
  \item[\quad] \joehl{Monaco JD} and Abbott LF. (2006). \unpubtitle{Entorhinal
    input and the remapping of hippocampal place fields}. \emph{Cosyne}. Salt Lake
    City, UT. March~2006.
  \item[\quad] \joehl{Monaco JD} and Levy WB. (2003). \unpubtitle{T-maze
      training of a recurrent CA3 model reveals the necessity of novelty-based
    modulation of LTP in hippocampal region CA3}. \emph{IJCNN}. Portland, OR.
    July~2003.
  \item[\quad] \joehl{Monaco JD} and Perlstein RP. (1997).
    \unpubtitle{Monte-Carlo analysis of deoxyhypusine synthase inhibitor ligand
    conformations}. \emph{NIH Poster Day}. Bethesda, MD. August~1997.
\end{description}

\subheading{Inventions \& Patents}

\lefttabline{0.8in}{5/9/2019}{Inventor, Neuroinspired Algorithms for Swarming
Applications, provisional patent 5012-5279}
\lefttabline{0.8in}{1/3/2019}{Inventor, Neuroinspired Algorithms for Swarming
Applications, provisional patent 5012-SPL}

\pagebreak
\heading{Organizational Activity}

\subheading{Journal Peer Review}
...
\subheading{Professional Societies}
...
\subheading{Conference Organization}
