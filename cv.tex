...
\begin{itemize}
  \item
    \begin{tabular*}{6.3in}{l@{\extracolsep{\fill}}r}
      ...
      %Collaborators: Kechen Zhang; JHU/Applied Physics Laboratory (JHU/APL) \\
  ...
  \item
    \begin{tabular*}{6.3in}{l@{\extracolsep{\fill}}r}
      ...
      %\qquad JHU/APL\\  % Kathleen E.~Cullen (JHU); 
    \end{tabular*}
...
\begin{description}
  \item Buckley E, \joehl{Monaco JD}, Schultz KM, Chalmers R, Hadzic A, Zhang
    K, Hwang GM, and Carr MD. (Under review). \itemtitle{An interdisciplinary
      approach to high school curriculum development: Swarming Powered by
    Neuroscience}. \emph{Frontiers in Education}.
  \item \joehl{Monaco JD}, Rajan K, and Hwang GM. (In revision). \itemtitle{A
    brain basis of dynamical intelligence for AI and computational neuroscience}.
...
\begin{description}
  \item \href{https://jdmonaco.com/}
    {``\itemtitle{Briefly Balanced: Theory-driven behavioral neuroscience in
