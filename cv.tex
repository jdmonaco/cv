...
\begin{description}
\item \textbf{Monaco JD}, Blair HT, and Zhang K. (under review). Spatial synchrony of coupled firing rate and theta phase in hippocampal-septal circuits. PLOS Computational Biology.
\item \href{https://www.cell.com/cell/fulltext/S0092-8674(18)31228-5}{Tabuchi M, \textbf{Monaco JD}, Duan G, Bell BJ, Liu S, Zhang K, and Wu MN. (2018). Clock-generated temporal codes determine synaptic plasticity to control sleep. \emph{Cell}, [Epub ahead of print]. doi:~10.1016/j.cell.2018.09.016}.
...
\begin{itemize}
\item NSF\slash NCS FOUNDATIONS Award No.~1835279, 2018--2020

\begin{itemize}
\item \emph{NCS-FO: Spatial intelligence for swarms based on hippocampal dynamics}
...
\item NIH/NINDS R03 Award No.~NS109923--01, 2018--2020

\begin{itemize}
\item \emph{Spiking network models of sharp-wave ripple sequences with gamma-locked attractor dynamics}

\item \textbf{PI:} Kechen Zhang; \textbf{Research Associate:} Joseph D. Monaco

\end{itemize}

\item Johns Hopkins Discovery Award, 2018--2019

\begin{itemize}
\item \emph{A dynamical systems approach to understanding the neural computations underlying our sense of direction}

\item \textbf{PIs:} Kathleen Cullen, James J.~Knierim, and Kechen Zhang; \textbf{Research Associate:} Joseph D.~Monaco

\end{itemize}

\item Johns Hopkins Science of Learning Institute Award, 2016--2018

\begin{itemize}
\item \emph{Learning to explore paths through space}
...
\begin{itemize}
  \item Neural Computation, \emph{Ad hoc reviewer}
  \item PeerJ, \emph{Ad-hoc reviewer}
  \item PLOS ONE, \emph{Ad hoc reviewer}
