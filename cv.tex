...
\begin{description}
  \item \joehl{Monaco JD}, Rajan K, and Hwang GM. (\emph{Invited Perspective;
      Submitted/under consideration}). \itemtitle{A brain basis of dynamical
      intelligence for AI and computational neuroscience}. \emph{Nature Machine
    Intelligence}.
...
\subsection*{Previous External Support} \label{sec:prevsupport}
...
\begin{tabular}{@{\hspace{0.2in}}l>{\raggedright\arraybackslash}p{.82\textwidth}}
  2021--present \hspace{0.1in} & Darius Carr, STEM high school student; I am
  mentoring Darius as part of a local high school program that facilitates
  research internships for underrepresented students. I am developing a
  computational research project with him that extends his current interests and
  experience with neuroscience concepts and python programming. \\
\end{tabular}
% split table to allow for page break
\begin{tabular}{@{\hspace{0.2in}}l>{\raggedright\arraybackslash}p{.82\textwidth}}
