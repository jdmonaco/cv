...
\begin{itemize}
  \item \href{https://www.fastcompany.com/90529833/best-workplaces-for-innovators-2020 -johns-hopkins-university-apl} 
    ...
    \itemnote{My NSF project (see Award No.~1835279 below) was the basis for \#3 ranking of JHUAPL.}
...
\subsection*{Leadership \& Project Management}
\label{sec:res}
...
\subsection*{Journals}\label{sec:review}
...
\lefttabline{0.8in}{2022--2023}{American Physical Society, Regular Member}
\lefttabline{0.8in}{2011--2020}{Society for Neuroscience, Postdoc/Regular Member}
...
\newsection{Recognition \& Awards}{awards}
