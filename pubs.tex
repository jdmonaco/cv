...
\begin{description}
  \item Hadzic A, Hwang GM, Zhang K, Schultz KM, and \joehl{Monaco JD}.
    (\emph{\color{lightred}In preparation}). \itemtitle{Bayesian optimization of
...
\begin{description}
  \item \href{https://jdmonaco.com/files/hadzic-2021-arxiv-submission4006134.pdf}{
      Hadzic A, Hwang GM, Zhang K, Schultz KM, and \joehl{Monaco JD}. (2021).
    \itemtitle{Bayesian optimization of distributed neurodynamical controller
    models for spatial navigation}. \arxiv{submit/4006134}}
