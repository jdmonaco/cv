...
\begin{description}
  \item Hwang GM, Kulwatno J, Cruz TH, Chen D, Ajisafe T, \joehl{Monaco
    JD}, Nitkin R, George SM, Lucas C, Zehnder SM, and Zhang L.
    (\emph{\color{lightred}In press}). \unpubtitle{Transforming Modeling in
...
\begin{description}
  ...
  \href{https://jdmonaco.com/files/monaco-phdthesis-2009.pdf}{[\itemtitle{pdf}]}
\end{description}
