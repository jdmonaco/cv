...
Overall, from 2009 to 2022, I have three (3) years of Research Associate
faculty experience developing and administering an independent cross-divisional
and interdisciplinary research program~\see{job1}, five (5) years of
postdoctoral experience performing preclinical health-related neuroscience
research~\see{job2}, and five (5) years of postdoctoral experience in
statistical neurobehavioral modeling and neural data science~\see{job3}. Over
these thirteen (13) years across three positions, I developed skills for
strategic planning related to resource allocation and project management in
varied scientific and administrative contexts.
...
From 2009 to present, I have established scientific distinction through
sustained research contributions in computational neuroscience, culminating
in publications in prestigious journals including Nature Neuroscience, Cell,
PLOS Computational Biology, and Journal of Neuroscience. My work on spatial
cognition, neural computation, and theoretical neuroscience has been recognized
through invited presentations at major institutions and conferences. Recent
invitations to speak at high-profile venues like INCF, SfN, NeurIPS, and
the BRAIN Initiative's Neuroethics Working Group (NEWG) reflect my growing
scientific impact. \cfcf{journalpubs}{talks}.

From 2016 to 2018, as a JHU/SOM Postdoctoral Fellow~\see{job2}, I independently
...
%also detailed in \cfonly{resprogram}, \cfonly{service}, \cfonly{talks},
...
\pagebreak
\section*{Self-Assessment Questionnaire --- Supporting Details}
\vspace{-.1in}
\hrule
\vspace{.3in}
...
\begin{enumerate}
  ...
  \item Appoint and manage grants, contracts, or cooperative agreements review
    ...
    \item Review applications for funding created by others to ensure
      they have been prepared properly. \itemnote{Reviewing NIH grant
        ...
        agencies~\see{funding}~\see{resprogram}, which has given me substantial
  ...
  \item Resolve conflicts, differences, or problems among colleagues,
    ...
    projects of various size and scope. \cfcf{resprogram}{mentoring}.}
\end{enumerate}
...
\section{NIH/NINDS Scientific Program Manager [C]}
\label{sec:jobobd}

\begin{tabular*}{6.3in}{l@{\extracolsep{\fill}}r}
  \textbf{Scientific Program Manager} & NSC Bldg \\
  \textbf{Office of the BRAIN Director} & 6001 Executive Blvd \\
  National Institutes of Health, NINDS &  Rockville, MD\\
...
\pagebreak
\section*{Scientific/Professional Workshops, Seminars, and Talks}
\label{sec:talks}
\vspace{-.1in}
\hrule
\vspace{.2in}
